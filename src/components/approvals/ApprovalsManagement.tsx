      ...
      <div className="grid gap-6">
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4">
            {[
              { id: 1, type: 'Claim Payment', client: 'John Doe', amount: 12000000, description: 'Motor vehicle accident claim' },
              { id: 2, type: 'Premium Refund', client: 'Jane Smith', amount: 2880000, description: 'Policy cancellation refund' }
            ].map(approval => (
              <div key={approval.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                <div className="flex-1">
                  ...
                  <p className="text-sm font-medium text-gray-800">Amount: {approval.amount.toLocaleString()} TZS</p>
                </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4">
            {[
              { id: 1, type: 'High Value Policy', client: 'Robert Johnson', amount: 1200000000, product: 'Commercial Property Insurance' },
              { id: 2, type: 'Special Risk Policy', client: 'Corporate Client Ltd', amount: 2400000000, product: 'Directors & Officers Insurance' }
            ].map(approval => (
              <div key={approval.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                <div className="flex-1">
                  <h5 className="font-medium text-gray-800">{approval.type}</h5>
                  ...
                  <p className="text-sm font-medium text-gray-800">Coverage: {approval.amount.toLocaleString()} TZS</p>
                </div>
                <div className="flex space-x-2">
